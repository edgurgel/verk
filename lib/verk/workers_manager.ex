defmodule Verk.WorkersManager do
  ...
  @doc """
  Fetches status of the queue. It can be :running, :pausing or :paused
  """
  @spec status(binary | atom) :: :runnning | :pausing | :paused
  def status(queue), do: GenServer.call(name(queue), :status)
